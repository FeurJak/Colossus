...
impl ecvrf::VRFKeyStorage for crate::ecvrf::HardCodedAkdVRF {
    async fn retrieve(&self) -> Result<Vec<u8>, crate::VrfError> {
        hex::decode("c9afa9d845ba75166b5c215767b1d6934e50c3db36e89b127b8a622b120f6721")
            .map_err(|hex_err| crate::VrfError::PublicKey(hex_err.to_string()))
    }
}
