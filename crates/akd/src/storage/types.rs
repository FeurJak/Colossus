...
use colossus_types::{AkdLabel, AkdValue, AzksValue, NodeLabel};
...
impl crate::SizeOf for ValueState {
...
impl ValueState {
    pub(crate) fn new(
        ...
        ValueState { value: plaintext_val, version, label, epoch, username }
    }
}
...
impl crate::SizeOf for DbRecord {
    fn size_of(&self) -> usize {
        match &self {
