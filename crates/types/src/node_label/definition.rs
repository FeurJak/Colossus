...
use super::serde_helpers::{bytes_deserialize_hex, bytes_serialize_hex};
use alloc::format;
...
impl NodeLabel {
    ...
    pub fn get_longest_common_prefix<TC: Configuration>(&self, other: NodeLabel) -> Self {
        ...
        let shorter_len =
            if self.label_len < other.label_len { self.label_len } else { other.label_len };
    ...
    pub(super) fn get_bit_at(&self, index: u32) -> Result<Bit, String> {
