...
use super::{
    AccessPolicy, Attribute, AttributeStatus, Dict, Dimension, EncryptionHint, Error,
    QualifiedAttribute, Right,
};

impl super::AccessStructure {
...
fn combine(
    ...
    if dimensions.is_empty() {
        vec![(vec![], EncryptionHint::Classic, AttributeStatus::EncryptDecrypt)]
    } else {
...
mod serialization {
    ...
    impl Serializable for AccessStructure {
        ...
        fn read(de: &mut Deserializer) -> Result<Self, Self::Error> {
            ...
            Ok(Self { version: Version::V1, dimensions })
        }
    }
